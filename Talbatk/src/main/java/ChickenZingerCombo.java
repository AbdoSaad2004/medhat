...
public class ChickenZingerCombo extends javax.swing.JFrame {
 

    PrintWriter in6 =new PrintWriter(new FileWriter("ChickenZinger.txt"));
    
    public ChickenZingerCombo() throws IOException {
        initComponents();
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        ...
        int type_C = 0;
        test.a6 =(int) jSpinner1.getValue();
        jButton1.setText("Add to basket                                        EGP "+ (test.a6*(100+type_C)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        test.T6=jLabel1.getText();
        test.setprice(100*test.a6);
        test.P6=test.getPrice();
        in6.println(test.a6+" "+test.T6+" "+ test.P6);
        in6.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChickenZingerCombo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ChickenZingerCombo().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(ChickenZingerCombo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
