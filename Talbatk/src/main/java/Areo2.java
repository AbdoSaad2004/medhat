 ...
 * @author abdo
 */
public class Areo2 extends javax.swing.JFrame {

    /**
     * Creates new form Areo2
     */
    PrintWriter in2 =new PrintWriter(new FileWriter("Areo2.txt"));
    public Areo2() throws IOException {
        initComponents();
        jSpinner1.addChangeListener((ChangeEvent e) -> {
        test.a8 =(int) jSpinner1.getValue();
        jButton1.setText("Add to basket                                        EGP "+ (45*test.a8));
    });
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        test.T8=jLabel1.getText();

        //int  a =(int) jSpinner1.getValue();
        //test.c=a;
        test.setprice(45*test.a8);

        test.P8=test.getPrice();
        in2.println(test.a8+" "+test.T8+" "+ test.P8);
        in2.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Areo2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Areo2().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(Areo2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
